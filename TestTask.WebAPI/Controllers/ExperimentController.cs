...
namespace TestTask.WebAPI.Controllers
{
    ...
    public class ExperimentController : ControllerBase
    {
        ...
        public async Task<IActionResult> ButtonColor([FromQuery(Name = "device-token")] string deviceToken)
        {
            ...
            if (device != null)
            {
                //Only new users can participate in the experiments
                ...
                {
                    //Each user can participate only in one experiment(If I understood the task correctly)
        ...
        public async Task<IActionResult> Statistics()
        {
            ...
            var result = new { totalNumberOfDevices = devices.Count,
